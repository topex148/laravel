...
Route::get('/nosotros', 'ControladorPrincipal@nosotros')->name('nosotros');
Route::get('/atractivoLista', 'ControladorPrincipal@atractivoLista')->name('atractivos');
Route::get('/atractivoLista/{atractivo}/atractivo', 'ControladorPrincipal@atractivo');
Route::get('/zonaLista', 'ControladorPrincipal@zonaLista')->name('zonas');
Route::get('/zonaLista/{zona}/zona', 'ControladorPrincipal@zona');
Route::get('/actividadLista', 'ControladorPrincipal@actividadLista')->name('actividades');
Route::get('/actividad', 'ControladorPrincipal@actividad');
Route::get('/servicioLista', 'ControladorPrincipal@servicioLista')->name('servicios');
...
Route::get('/galeria', 'ControladorPrincipal@galeria')->name('galeria');
Route::get('/plan', 'PaymentsController@planPromocion')->name('planes');
