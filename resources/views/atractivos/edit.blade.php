...
<!-- CONTACT -->
            ...
            <form action="/LaTesis/public/atractivos/{{$atractivo->id}}" method="POST" role="form">
              ...
              {{csrf_field()}}
							...
							<div class="row">
									...
									<div class="col-md-6">
										<h5>ID de Zona</h5>
										<!-- date picker -->
										<input type="text" value="{{$atractivo->zona_id}}" class="form-control"  name="zona_id"  placeholder="Ingrese el ID Zona">
